...
// Pin to version in tailscale.com/go.mod to avoid build issues.. WTF!
replace gvisor.dev/gvisor => gvisor.dev/gvisor v0.0.0-20240722211153-64c016c92987
